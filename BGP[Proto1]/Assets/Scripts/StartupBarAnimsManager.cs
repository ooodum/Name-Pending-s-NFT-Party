...
public class StartupBarAnimsManager : MonoBehaviour
{
    ...
    void Start() {
        ...
        LeanTween.move(bar1, Vector2.up * bar1.rect.height*1.5f, 2).setDelay(1.5f).setEaseInOutQuint().setDestroyOnComplete(true);
        LeanTween.move(bar2, -Vector2.up * bar2.rect.height*1.5f, 2).setDelay(1.5f).setEaseInOutQuint().setDestroyOnComplete(true);
    }
